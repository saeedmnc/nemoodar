  ...
  disableObservation(function () {
    toArray(root.querySelectorAll('*')).filter(function (n) {
      ...
      [':before', ':after'].forEach(function (pos) {
        ...
        var font-family = styles.getPropertyValue('font-family').match(FONT_FAMILY_PATTERN);
        var fontWeight = styles.getPropertyValue('font-weight');

        if (alreadyProcessedPseudoElement && !font-family) {
          ...
          var prefix = ~['Light', 'Regular', 'Solid', 'Brands'].indexOf(font-family[1]) ? STYLE_TO_PREFIX[font-family[1]] : FONT_WEIGHT_TO_PREFIX[fontWeight];
